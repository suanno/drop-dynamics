...
[p.mat.K,p.mat.M,~]=p.pdeo.fem.assema(p.pdeo.grid,1,1,1); 
p.mat.Kx=convection(fem,gr,1); 
%p.mat.Kx=filltrafo(p,Kx); % Convection matrix needed for phase condition (translational invariance)
