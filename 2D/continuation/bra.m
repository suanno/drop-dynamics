...
Hout_ = H(end);
%Hout = Hout_; % The estimate of Hout from Hmax is wrong! Problem as it
%makes the result depend on the box size as integrals of Hhat do not converge with
%box size going to infinity!
Hhat = H-Hout_*e1;
